...
public class MemberControllerTest {
	...
	public void joinTest() throws Exception {
		mockMvc.perform(post("/member/join").param("userId", "tes1tMethod3").param("password", "1234")
				.param("tell", "010-1234-4321").param("email", "testMethod@testmethod")).andExpect(status().isOk())
				.andDo(print());
	}
	...
	public void loginImpl() throws Exception {
		mockMvc.perform(post("/member/login").param("userId", "DEV").param("password", "ppppp"))
	...
	public void mypage() throws Exception {
		...
		mockMvc.perform(get("/member/mypage").cookie(new Cookie("JSESSIONID", "123412312314123"))
				.sessionAttr("authentication", member)).andExpect(status().isOk()).andDo(print());
	}

	@Test
	public void idCheck() throws Exception {
		mockMvc.perform(get("/member/id-check?userId=test")).andExpect(status().isOk()).andDo(print());
	}
