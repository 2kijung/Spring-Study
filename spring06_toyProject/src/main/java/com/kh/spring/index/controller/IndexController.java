...
public class IndexController {
	 ...
	 *5. @RequestParam : 요청 파라미터를 건트롤러 메서드의 매개변수에 바인드 
	 *					단 Content-type이 application/x-www-form-urlEncoded 인 경우에만 가능
	 *					FormHtttpMessageConverter가 동작
	 ...
	 *9. @SessionAttribute : 원하는 session의 속성ㄱ밧을 매개변수에 바인드
	...
	*	HttpServlertRequest, HttpServlerResponse, HttpSession
	*/
	
	@GetMapping("/")
	public String index() { 
	//Controller메서드의 return타입
